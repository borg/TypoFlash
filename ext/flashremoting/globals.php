<?php
	...
	// Use the same configuration settings as SWX for 
	// the services folder (and VOs, although SWX doesn't support VOs at the moment
	// it makes sense to keep them in the same place.)
