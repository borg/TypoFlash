...
$TCA['tt_news'] = Array (
	...
	'types' => Array (
		'0' => Array('showitem' =>
			'title;;1;;,type,editlock,datetime;;2;;1-1-1,author;;3;;,short;;4;richtext:rte_transform[flag=rte_enabled|mode=ts];4-4-4,no_auto_pb,
			--div--;Relations,bodytext;;4;richtext:rte_transform[flag=rte_enabled|mode=ts];4-4-4,no_auto_pb,
...
$TCA['tt_news_cat'] = Array (
	...
	'interface' => Array (
		'showRecordFieldList' => 'title,image,shortcut,shortcut_target,sorting'
	),
	'columns' => Array (
		'title' => Array (
			'label' => 'LLL:EXT:lang/locallang_general.php:LGL.title',
...
$TCA['tt_news_cat']['ctrl']['default_sortby']='ORDER BY title,sorting';
?>