...
package twitter.api {
	...
	public class Twitter extends EventDispatcher
	{
		...
		private static const LOAD_FRIENDS_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=statuses/friends/$userId.xml";
		private static const LOAD_FRIENDS_TIMELINE_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=statuses/friends_timeline/$userId.xml";
		private static const PUBLIC_TIMELINE_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=statuses/public_timeline.xml"
		private static const LOAD_USER_TIMELINE_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=statuses/user_timeline/$userId.xml"
		private static const FOLLOW_USER_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=friendships/create/$userId.xml";
		private static const SET_STATUS_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=statuses/update.xml";
		private static const SHOW_STATUS_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=statuses/show/$id.xml";
		private static const REPLIES_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=statuses/replies.xml";
		private static const DESTROY_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=statuses/destroy/$id.xml";
		private static const FOLLOWERS_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=statuses/followers.xml";
		private static const FEATURED_USERS_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=statuses/featured.xml";
		private static const GET_DIRECT_MSGS_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=direct_messages.xml?";
		private static const SEND_DIRECT_MSG_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=direct_messages/new.xml";
		//private static const SEARCH_URL:String =
			//TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?sd=search&path=search.atom?";
		private static const VERIFY_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=account/verify_credentials.xml";
		private static const UPDATE_LOCATON_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=account/update_location";
		private static const RATE_LIMIT_STATUS_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=account/rate_limit_status.xml";
		private static const END_SESSION_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=account/end_session.xml";
		private static const GET_SENT_DIRECT_MESSAGE_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=direct_messages/sent.xml";
		private static const SHOW_INFO_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=users/show/${id}.xml";
		private static const FRIENDS_IDS_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=friends/ids/${id}.xml";
		private static const FOLLOWERS_IDS_URL:String =
			TF_CONF['HOST_URL']+"/typo3conf/ext/flashremoting/lib/twitter/proxy.php?path=followers/ids/${id}.xml";
		...
		private static const SEND_DIRECT_MSG_URL:String = 
			...
			//search.twitter.com allowes all domains, no need for proxy and consuming calls from same source
		private static const SEARCH_URL:String = 
		...
		*/
		...
		public function loadInfo(user:String):void {
			...
			trace(SHOW_INFO_URL.replace("${id}", user))
		...
		private function userTimelineHandler(e:Event):void {
			try{
				...
				Debug.output("Twitter.userTimelineHandler error "+e)
			}			
		}
		...
		private function followersHandler(e:Event):void {
			try{
				...
				Debug.output("Twitter.followersHandler error "+e)
			}	
		}
		...
		/*
		 * Result stored as a list of users
		 */ 
		private function searchHandler(e:Event):void{
			...
			try{
				...
				for each (entryXml in xml.atom::entry)	{
					...
					//Borg mod. Extract name from xml. Odd API.
					entry.user = new TwitterUser();
					entry.user.screenName = String(entryXml.atom::author.atom::name).substring(0, String(entryXml.atom::author.atom::name).indexOf("(")-1);
					entry.user.name = String(entryXml.atom::author.atom::name).substring(String(entryXml.atom::author.atom::name).indexOf("(")+1, String(entryXml.atom::author.atom::name).indexOf(")"));
				...
				Debug.output("Twitter.searchHandler error. Bad xml? "+e)
		...
		private function showInfoHandler(event:Event):void {
			try{
				...
				Debug.output("Twitter.showInfoHandler error "+e)
			}
		}
